<?php include('header.php') ?> (2018)</title>


		<style type="text/css">
		:root{
			--body: #7C315A linear-gradient(to top left, #7C315A 0%, #403582 100%);
			--body-border: #403582;
			--container: #fafafa; 
			--h1: #403582;
			--h2: #7C315A;
	...
	<div id="navigation">
			...
			<span class="prev">
				<a href="2017">&larr; Previous</a>
			</span>

			<span class="next">
				<a href="2019">Next &rarr;</a>
			</span>
		</div>
